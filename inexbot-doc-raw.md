...
> 本文档索引基于 doc.inexbot.com（507篇文档，含349篇独立伺服报错页面，含25.01版本4篇新文档）。
...
- `产品资料_控制系统_t31竖版示教器.md` — T31 竖版示教器
...
### 技术资料（5篇）
- `技术资料_常见问题与解决方案_伺服报错代码.md` — 伺服报警代码含义与处理方法
- `技术资料_支持的伺服型号.md` — 支持的伺服驱动品牌/型号列表
- `技术资料_支持的外部轴类型.md` — 支持的外部轴
- `技术资料_支持的机器人类型.md` — 支持的机器人构型
- `技术资料_通讯协议_地址码.md` — 通讯协议地址定义

### 操作手册 22.07版本（25篇）
- `操作手册_22.07版本_系统操作手册.md` — 开机、关机、急停、模式切换
- `操作手册_22.07版本_系统设置与文件导入导出手册.md` — 系统参数备份/还原
- `操作手册_22.07版本_调试手册.md` — 现场调试流程
- `操作手册_22.07版本_指令集手册.md` — 示教编程指令集
- `操作手册_22.07版本_100个全局位置变量现场应用手册.md` — 全局位置变量
- `操作手册_22.07版本_工具手标定手册.md` — TCP 标定
- `操作手册_22.07版本_用户坐标标定手册.md` — 工件坐标系标定
- `操作手册_22.07版本_六轴协作机器人操作手册.md` — 6轴协作机器人操作
- `操作手册_22.07版本_焊接工艺手册.md` — 焊接工艺
- `操作手册_22.07版本_打磨工艺手册.md` — 打磨工艺
...
- `操作手册_22.07版本_io_modbus与远程功能使用手册.md` — Modbus RTU/TCP
- `操作手册_22.07版本_网络功能使用手册.md` — Ethernet 通讯配置
- `操作手册_22.07版本_人机协作手册.md` — 协作模式
- `操作手册_22.07版本_多机模式与双机协作手册.md` — 多机通讯
- `操作手册_22.07版本_自适应加减速手册.md` — 自适应速度控制
- `操作手册_22.07版本_四轴并联机器人操作手册.md` — Delta 并联机器人
- `操作手册_22.07版本_酒槽机型机器人手册.md` — 酒槽机型专用手册

### 操作手册 24.03版本（78篇）
- `操作手册_24.03版本_运动控制类指令.md` — 运动指令详解
- `操作手册_24.03版本_程序控制类指令.md` — IF/WHILE/FOR/子程序
- `操作手册_24.03版本_变量手册.md` — 位置/数值/字符串变量
- `操作手册_24.03版本_条件控制类指令.md` — 条件判断
- `操作手册_24.03版本_调试手册.md` — 24.03版调试
- `操作手册_24.03版本_系统操作手册.md` — 24.03版系统操作
- `操作手册_24.03版本_lua教程.md` — LUA 脚本编程
- `操作手册_24.03版本_dev多语言功能使用教程.md` — 多语言SDK
- `操作手册_24.03版本_tcp通讯功能手册.md` — TCP Server/Client
- `操作手册_24.03版本_modbus功能使用手册.md` — Modbus RTU/TCP
- `操作手册_24.03版本_modbus多主站连接.md` — 多主站 Modbus
- `操作手册_24.03版本_eip功能操作说明.md` — EtherNet/IP
- `操作手册_24.03版本_opc-ua参数.md` — OPC-UA
- `操作手册_24.03版本_7000端口.md` — 7000端口协议
- `操作手册_24.03版本_finstcp使用手册.md` — FinTCP
- `操作手册_24.03版本_pc支持仿真软件使用教程.md` — PC 仿真软件
- `操作手册_24.03版本_机器人dh参数说明.md` — DH 参数配置
- `操作手册_24.03版本_机器人的构成.md` — 机器人机械结构
- `操作手册_24.03版本_六轴协作机器人增加形态参数.md` — 协作机器人形态参数
- `操作手册_24.03版本_机器人定制适配_珞石cr20-c.md` — 珞石 CR20-C
- `操作手册_24.03版本_机器人定制适配_珞石sr5-c.md` — 珞石 SR5-C
- `操作手册_24.03版本_机器人定制适配_法奥fr5.md` — 法奥 FR5
- `操作手册_24.03版本_机器人定制适配_越疆cr10v.md` — 越疆 CR10V
- `操作手册_24.03版本_机器人定制适配_天机七轴cbcbcba.md` — 天机七轴
- `操作手册_24.03版本_计算目标形态指令.md` — 目标姿态计算
- `操作手册_24.03版本_外部轴使用手册.md` — 外部轴配置
- `操作手册_24.03版本_外部轴点动_联动.md` — 外部轴点动/联动
- `操作手册_24.03版本_外部轴速度.md` — 外部轴速度参数
- `操作手册_24.03版本_独立轴控制.md` — 独立轴控制模式
- `操作手册_24.03版本_外部点tcp.md` — 外部 TCP
- `操作手册_24.03版本_工具手标定手册.md` — TCP 标定
- `操作手册_24.03版本_用户坐标标定手册.md` — 工件坐标标定
- `操作手册_24.03版本_坐标系类.md` — 坐标系指令
- `操作手册_24.03版本_焊接工艺.md` — 焊接参数
- `操作手册_24.03版本_激光切割工艺.md` — 激光切割
- `操作手册_24.03版本_打磨工艺手册.md` — 打磨工艺
- `操作手册_24.03版本_码垛工艺.md` — 码垛
- `操作手册_24.03版本_视觉工艺.md` — 视觉集成
- `操作手册_24.03版本_传送带跟踪工艺手册.md` — 传送带跟踪
- `操作手册_24.03版本_新传送带跟踪工艺手册.md` — 新版传送带跟踪
- `操作手册_24.03版本_寻位跟踪手册.md` — 寻位跟踪
- `操作手册_24.03版本_干涉区.md` — 干涉区设置
- `操作手册_24.03版本_鱼鳞焊首段焊接首段空走.md` — 鱼鳞焊
- `操作手册_24.03版本_特殊工艺_专用工艺.md` — 专用工艺
- `操作手册_24.03版本_特殊工艺_晶圆工艺.md` — 晶圆搬运
- `操作手册_24.03版本_位置变量类.md` — 位置变量
- `操作手册_24.03版本_修改机器人点位.md` — 点位修改
- `操作手册_24.03版本_反向间隙.md` — 反向间隙补偿
- `操作手册_24.03版本_最小加速度时间与最小减速度时间.md` — 加减速参数
- `操作手册_24.03版本_伺服响应时间.md` — 伺服响应调节
- `操作手册_24.03版本_字符串类_输入输出类_定时器类_运算类指令手册.md` — 字符串/IO/定时器
- `操作手册_24.03版本_io报警信息.md` — IO 报警代码
- `操作手册_24.03版本_数据上传.md` — 数据上传
...
- `操作手册_24.03版本_恢复出厂设置后如何让机器人运动.md` — 出厂恢复
...
- `操作手册_24.03版本_示教器与控制器多语言翻译及升级指南.md` — 多语言翻译
...
### 二次开发（SDK / TCP）
→ `操作手册_24.03版本_7000端口.md` — JSON over TCP 控制协议
→ `操作手册_24.03版本_tcp通讯功能手册.md` — TCP Server/Client
...
**Q: 如何用 Python 连接控制器？**
A: 两种主流方式：① 使用 7000 端口协议（JSON over TCP）；② 使用 TCP Server/Client 自定义通信。
