...
| `产品资料_控制系统_c1102.md` | C1102 控制器资料 |
...
| `产品资料_显控一体机_xpc-150-c1100显控一体机.md` | XPC-150-C1100 显控一体机 |
...
| `操作手册_22.07版本_点胶工艺手册.md` | 点胶工艺（含视觉） |
...
| 文档 | 用途 |
|------|------|
| `操作手册_24.03版本_指令集手册.md` | 24.03版完整指令集（最重要）|
...
| `操作手册_24.03版本_四轴并联机器人操作手册.md` | Delta 机器人操作 |
...
| `操作手册_24.03版本_字符串类_输入输出类_定时器类_运算类指令手册.md` | 各类指令 |
| `操作手册_24.03版本_语法检测功能.md` | 语法检查 |
| `操作手册_24.03版本_条件控制类指令.md` | 条件指令 |
...
| `操作手册_24.03版本_天机需求.md` / `森峰需求.md` | 客户定制需求 |
...
| 工艺 | 推荐文档 |
|------|------|
| 焊接 | `操作手册_24.03版本_焊接工艺.md` + `操作手册_24.03版本_鱼鳞焊...` |
| 打磨 | `操作手册_24.03版本_打磨工艺手册.md` |
| 点胶 | `操作手册_22.07版本_点胶工艺手册.md` |
...
在 doc.inexbot.com 查看具体文档：
```
https://doc.inexbot.com/【文档完整名称】
```
例如：
```
https://doc.inexbot.com/操作手册_24.03版本_指令集手册.md
...
**Q: C1201 控制器支持哪些通讯接口？**
A: C1201 内置多网口（EtherCAT）、数字输入/输出端口、RS485/232 COM 接口以及 CAN 接口。
→ `产品资料_控制系统_工业机器人控制器c1201.md`
...
**Q: 如何用 Python 连接控制器？**
A: 使用 TCP 通讯协议，参考 7000 端口说明或多语言 SDK 教程。
→ `操作手册_24.03版本_dev多语言功能使用教程.md` + `操作手册_24.03版本_7000端口.md`
