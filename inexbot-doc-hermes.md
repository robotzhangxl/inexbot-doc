...
description: 纳博特（inexbot）机器人控制系统的技术顾问skill，涵盖产品选型、配置调试、二次开发、工艺应用全流程。文档索引基于 doc.inexbot.com（541篇文档，含349篇独立伺服报错页面，含25.01版本41篇新文档）。**2026-07-21 更新**：站点 25.01 版本新增 6 篇文档（IO功能、专用工艺、人机协作、多机协调、新双机功能、独立轴控制）。**每次回答问题后自动追加 Q&A 到下方缓存区。**

> 🕐 上次自动同步: 2026-07-21 — 25.01 版本新增 6 篇文档
---
